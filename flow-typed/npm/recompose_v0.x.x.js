...
declare module "recompose" {
  ...
  declare type Component<A> = React.Component<A>;
  ...
  declare function defaultProps<Default, Enhanced>(
    defProps: Default
  ): HOC<{ ...$Exact<Enhanced>, ...Default }, Enhanced>;

  declare function mapProps<Base, Enhanced>(
  ...
  declare function pure<A>(a: Component<A>): Component<A>;
  declare function onlyUpdateForPropTypes<A>(
    a: Component<A>
  ): Component<A>;
  declare function onlyUpdateForKeys<A>(Array<$Keys<A>>): HOC<A, A>;
  declare function shouldUpdate<A>(
    (props: A, nextProps: A) => boolean
  ): HOC<A, A>;

  declare function toClass<A>(a: Component<A>): Component<A>;

  declare function withContext<A, ContextPropTypes, ContextObj>(
    childContextTypes: ContextPropTypes,
    getChildContext: (props: A) => ContextObj
  ): HOC<A, A>;

  declare function getContext<CtxTypes, Enhanced>(
   ...
   */
  declare function renderNothing<A>(C: Component<A>): Component<A>;
  declare function renderComponent<A>(a: Component<A>): HOC<A, A>;

  /**
   * We make an assumtion that left and right have the same type if exists
   */
  declare function branch<Base, Enhanced>(
  ...
  declare function setPropTypes<A>(propTypes: Object): HOC<A, A>;
  declare function setDisplayName<A>(displayName: string): HOC<A, A>;

  declare function withPropsOnChange<BaseAdd, Enhanced>(
    shouldMapOrKeys:
  ...
  declare function flattenProp<Base, Enhanced>(
    propName: $Keys<Enhanced>
  ): HOC<Base, Enhanced>;

  // use withProps instead
  declare function renameProp<Base, Enhanced>(
    oldName: $Keys<Enhanced>,
    newName: $Keys<Base>
  ): HOC<Base, Enhanced>;

  // use withProps instead
  declare function renameProps<Base, Enhanced>(nameMap: {
    [key: $Keys<Enhanced>]: $Keys<Base>
  }): HOC<Base, Enhanced>;

  // use withStateHandlers instead
  declare function withState<Base, Enhanced, T>(
    stateName: string,
  ...
  declare function shallowEqual(objA: mixed, objB: mixed): boolean;
  ...
  declare function componentFromStream<T>(
    (props$: any) => any
  ): T => React.Element<any>;
